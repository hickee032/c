...
void std_lecture_input() {
	...
	/*while (seaechLength(lect.std.tel) == 1) {
	...
	//while (searchString(lect.std.email, '@') == 1) {
	//	printf("Email을 다시 입력하세요 : ");
	//	scanf("%s", lect.std.email);
	//}
	...
	//while (seaechLength(lect.prof.tel)==1) {
	//	printf("전화번호를 다시 입력하세요 : ");
	//	scanf("%s", lect.prof.tel);
	//}
	...
	//while (searchString(lect.prof.email, '@') == 1) {
	//	printf("Email을 다시 입력하세요 : ");
	//	scanf("%s", lect.prof.email);
	//}
